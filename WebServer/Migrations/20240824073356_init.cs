        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VodoSnabKolichAbonent = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Количество абонентов, охваченных централизованным водоснабжением (единиц)"),
                    VodoSnabKolFizLic = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. физических лиц/население (единиц)"),
                    VodoSnabKolYriLic = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. юридических лиц (единиц)"),
                    VodoSnabKolBydzhOrg = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. бюджетных организаций (единиц)"),
                    VodoSnabKolChelDostyp = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Количество населения имеющих доступ к  централизованному водоснабжению (человек)"),
                    VodoSnabObespechCentrlVodo = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоснабжение. Обеспеченность централизованным водоснабжением, в % гр.13/гр.6 *100"),
                    VodoSnabIndivUchetVodyVsego = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват индивидуальными приборами учета воды по состоянию на конец отчетного года - всего с нарастающим (единиц)"),
                    VodoSnabIndivUchetVodyDistance = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват индивидуальными приборами учета воды по состоянию на конец отчетного года - в том числе с дистанционной передачей данных в АСУЭ обслуживающего предприятия (единиц)"),
                    VodoSnabIndivUchetVodyPercent = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоснабжение. Охват индивидуальными приборами учета воды по состоянию на конец отчетного года - охват в %, гр.15/гр. 9*100"),
                    VodoSnabObshePodlezhashKolZdan = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват общедомовыми приборами учета воды по состоянию на конец отчетного года - Количество зданий и сооружений, подлежащих к установке общедомовых приборов учета (единиц)"),
                    VodoSnabObsheUstanKolZdan = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват общедомовыми приборами учета воды по состоянию на конец отчетного года - Количество зданий и сооружений с установленными общедомовыми приборами учета (единиц)"),
                    VodoSnabObsheUstanPriborKol = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват общедомовыми приборами учета воды по состоянию на конец отчетного года - Количество установленных общедомовых приборов учета (единиц)"),
                    VodoSnabObsheUstanDistanceKol = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Охват общедомовыми приборами учета воды по состоянию на конец отчетного года - в том числе с дистанционной передачей данных в АСУЭ обслуживающего предприятия (единиц)"),
                    VodoSnabObsheOhvatPercent = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоснабжение. Охват общедомовыми приборами учета воды по состоянию на конец отчетного года - охват в %, гр.19/гр. 18*100"),
                    VodoSnabAutoProccesVodoZabor = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Автоматизация производственных процессов водоснабжения и наличие централизованной системы контроля и управления (SCADA) - Водозабор (0 или 1)"),
                    VodoSnabAutoProccesVodoPodgot = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Автоматизация производственных процессов водоснабжения и наличие централизованной системы контроля и управления (SCADA) - Водоподготовка (0 или 1)"),
                    VodoSnabAutoProccesNasosStanc = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Автоматизация производственных процессов водоснабжения и наличие централизованной системы контроля и управления (SCADA) - Насосные станции (0 или 1)"),
                    VodoSnabAutoProccesSetVodosnab = table.Column<int>(type: "integer", nullable: true, comment: "Водоснабжение. Автоматизация производственных процессов водоснабжения и наличие централизованной системы контроля и управления (SCADA) - Сети водоснабжения (0 или 1)"),
                    VodoOtvKolAbonent = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Кол-во абонентов, охваченных централизованным водоотведением (единиц)"),
                    VodoOtvKolAbonFizLic = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Кол-во абонентов, охваченных централизованным водоотведением (единиц) - физических лиц/население (единиц)"),
                    VodoOtvKolAbonYriLic = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Кол-во абонентов, охваченных централизованным водоотведением (единиц) - юридических лиц (единиц)"),
                    VodoOtvKolBydzhetOrg = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Кол-во абонентов, охваченных централизованным водоотведением (единиц) - бюджетных организаций (единиц)"),
                    VodoOtvKolChelOhvatCentrVodo = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Численность населения, охваченного централизованным водоотведением, (человек)"),
                    VodoOtvDostypCentrVodo = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоотведение. Доступ к централизованному водоотведению, в % гр.31/гр.6*100"),
                    VodoOtvKolichKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Наличие канализационно-очистных сооружений, (единиц)"),
                    VodoOtvKolichKanalizMechan = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Наличие канализационно-очистных сооружений, (единиц) - только с механичес-кой очисткой (еди-ниц)"),
                    VodoOtvKolichKanalizMechanBiolog = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Наличие канализационно-очистных сооружений, (единиц) - с механической и биологической очист-кой (еди-ниц)"),
                    VodoOtvProizvodKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Производительность канализационно-очистных сооружений (проектная)"),
                    VodoOtvIznosKanaliz = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоотведение. Износ канализационно-очистных сооружений, в %"),
                    VodoOtvKolChelKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Численность населения, охваченного действующими канализационно-очистными сооружениями, (человек)"),
                    VodoOtvOhvatChelKanaliz = table.Column<decimal>(type: "numeric", nullable: true, comment: "Водоотведение. Охват населения очисткой сточных вод, в % гр.38/гр.6*100"),
                    VodoOtvFactPostypKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Фактически поступило сточных вод в канализационно-очистные сооружения (тыс.м3)"),
                    VodoOtvFactPostypKanaliz1kv = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Фактически поступило сточных вод в канализационно-очистные сооружения (тыс.м3) - За I квартал (тыс.м3)"),
                    VodoOtvFactPostypKanaliz2kv = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Фактически поступило сточных вод в канализационно-очистные сооружения (тыс.м3) - За II квартал (тыс.м3)"),
                    VodoOtvFactPostypKanaliz3kv = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Фактически поступило сточных вод в канализационно-очистные сооружения (тыс.м3) - За III квартал (тыс.м3)"),
                    VodoOtvFactPostypKanaliz4kv = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Фактически поступило сточных вод в канализационно-очистные сооружения (тыс.м3) - За IV квартал (тыс.м3)"),
                    VodoOtvObiemKanalizNormOchist = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Объем сточных вод, соответствующей нормативной очистке по собственному лабораторному мониторингу за отчетный период (тыс.м3)"),
                    VodoOtvUrovenNormOchishVody = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Уровень нормативно- очищенной воды, % гр.45/гр.40 * 100"),
                    VodoOtvAutoProccesSetKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Автоматизация производственных процессов водоотведения и наличие централизованной системы контроля и управления (SCADA) - Сети канализации (0 или 1)"),
                    VodoOtvAutoProccesKanalizNasos = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Автоматизация производственных процессов водоотведения и наличие централизованной системы контроля и управления (SCADA) - Канализационные насосные станции (0 или 1)"),
                    VodoOtvAutoProccesKanalizSooruzh = table.Column<int>(type: "integer", nullable: true, comment: "Водоотведение. Автоматизация производственных процессов водоотведения и наличие централизованной системы контроля и управления (SCADA) - Канализационно-очистные сооружения (0 или 1)"),
                    UrTarVodoSnabUsrednen = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоснабжение усредненный, тенге/м3"),
                    UrTarVodoSnabFizLic = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоснабжение физическим лицам/населению, тенге/м3"),
                    UrTarVodoSnabYriLic = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоснабжение юридическим лицам, тенге/м3"),
                    UrTarVodoSnabBydzhOrg = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоснабжение бюджетным организациям, тенге/м3"),
                    UrTarVodoOtvedUsred = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоотведение - усредненный, тенге/м3"),
                    UrTarVodoOtvedFizLic = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоотведение - физическим лицам/населению, тенге/м3"),
                    UrTarVodoOtvedYriLic = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоотведение - юридическим лицам, тенге/м3"),
                    UrTarVodoOtvedBydzhOrg = table.Column<int>(type: "integer", nullable: true, comment: "Уровень тарифов. водоотведение - бюджетным организациям, тенге/м3"),
                    LengthVodoProvodTotal = table.Column<int>(type: "integer", nullable: true, comment: "Протяженность водопроводных сетей, км (по состоянию на конец отчетного года) - общая, км"),
                    LengthVodoProvodIznos = table.Column<int>(type: "integer", nullable: true, comment: "Протяженность водопроводных сетей, км (по состоянию на конец отчетного года) - в том числе изношенных, км"),
                    LengthVodoProvodIznosPercent = table.Column<decimal>(type: "numeric", nullable: true, comment: "Протяженность водопроводных сетей, км (по состоянию на конец отчетного года) - Износ, % гр.59/гр.58"),
                    LengthKanalizTotal = table.Column<int>(type: "integer", nullable: true, comment: "Протяженность водопроводных сетей, км (по состоянию на конец отчетного года) - общая, км"),
                    LengthKanalizIznos = table.Column<int>(type: "integer", nullable: true, comment: "Протяженность канализационных сетей, км (по состоянию на конец отчетного года) - в том числе изношенных, км"),
                    LengthKanalizIznosPercent = table.Column<decimal>(type: "numeric", nullable: true, comment: "Протяженность канализационных сетей, км (по состоянию на конец отчетного года) - Износ, % гр.62/гр.61"),
                    LengthObshNewSetiVodo = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность построенных (новых) сетей в отчетном году, км - водоснабжения, км"),
                    LengthObshNewSetiKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность построенных (новых) сетей в отчетном году, км - водоотведения, км"),
                    LengthObshZamenSetiVodo = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность реконструированных (замененных) сетей в отчетном году, км - водоснабжения, км"),
                    LengthObshZamenSetiKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность реконструированных (замененных) сетей в отчетном году, км - водоотведения, км"),
                    LengthObshRemontSetiVodo = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность отремонтированных (текущий/капитальный ремонт) сетей в отчетном году, км - водоснабжения, км"),
                    LengthObshRemontSetiKanaliz = table.Column<int>(type: "integer", nullable: true, comment: "Общая протяженность отремонтированных (текущий/капитальный ремонт) сетей в отчетном году, км - водоотведения, км")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CentrVodoSnabKolNasPun = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. Кол-во сельских населенных пунктов (единиц)"),
                    CentrVodoSnabKolChel = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. Численность населения, проживающего в данных сельских населенных пунктах (человек)"),
                    CentrVodoSnabObesKolNasPunk = table.Column<decimal>(type: "numeric", nullable: true, comment: "Централизованное водоснабжение. Обеспеченность централизованным водоснабжением по количеству сельских населенных пунктов, % гр.19/гр.8 *100"),
                    CentrVodoSnabObesKolChel = table.Column<decimal>(type: "numeric", nullable: true, comment: "Централизованное водоснабжение. Обеспеченность централизованным водоснабжением по численности населения, % гр.20/гр.9 *100"),
                    CentrVodoSnabKolAbon = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. Кол-во абонентов, охваченных централизованным водоснабжением (единиц)"),
                    CentrVodoSnabFizLic = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. в том числе физических лиц/население (единиц)"),
                    CentrVodoSnabYriLic = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. в том числе юридических лиц (единиц)"),
                    CentrVodoSnabBudzhOrg = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. в том числе бюджетных организаций (единиц)"),
                    CentrVodoSnabIndivPriborUchVodyVsego = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. Всего установлено индивидуальных приборов учета воды по состоянию на конец отчетного года (единиц)"),
                    CentrVodoSnabIndivPriborUchVodyASYE = table.Column<int>(type: "integer", nullable: true, comment: "Централизованное водоснабжение. в том числе с дистанционной передачей данных в АСУЭ обслуживающего предприятия (единиц)"),
                    CentrVodoSnabIndivPriborUchVodyOhvat = table.Column<decimal>(type: "numeric", nullable: true, comment: "Централизованное водоснабжение. Охват индивидуальными приборами учета воды, % гр.27/гр. 23*100"),
                    NecVodosnabKolSelsNasPunk = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Количество сельских населенных пунктов (единиц)"),
                    NecVodosnabKbmKolSelsNasPunk = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение КБМ Количество сельских населенных пунктов, где установлено КБМ"),
                    NecVodosnabKbmKolChel = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение КБМ Численность населения, проживающего в сельских населенных пунктах, где установлены КБМ (человек)"),
                    NecVodosnabKbmObespNasel = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение КБМ Обеспеченность населения услугами КБМ, % гр.32/гр.9*100"),
                    NecVodosnabPrvKolSelsNasPunk = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение ПРВ Количество сельских населенных пунктов, где установлено ПРВ"),
                    NecVodosnabPrvKolChel = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение ПРВ Численность населения, проживающего в сельских населенных пунктах, где установлены ПРВ (человек)"),
                    NecVodosnabPrvObespNasel = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение ПРВ Обеспеченность населения услугами  ПРВ, % гр.35/гр.9*100"),
                    NecVodosnabPrivVodaKolSelsNasPunk = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Привозная вода Количество сельских населенных пунктов, жители которых используют привозную воду"),
                    NecVodosnabPrivVodaKolChel = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Привозная вода Численность населения, проживающего в сельских населенных пунктах, где используют привозную воду"),
                    NecVodosnabPrivVodaObespNasel = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение Привозная вода Обеспеченность населения привозной водой, % гр.38/гр.9*100"),
                    NecVodosnabSkvazhKolSelsNasPunk = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Количество сельских населенных пунктов, жители которых используют воду из скважин и колодцов"),
                    NecVodosnabSkvazhKolChel = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Численность населения, проживающего в сельских населенных пунктах, где используют  воду из скважин и колодцев"),
                    NecVodosnabSkvazhObespNasel = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Обеспеченность  привозной водой, % гр.41/гр.9*100"),
                    NecVodosnabSkvazhKolSelsNasPunkOtkaz = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Количество сельских населенных пунктов, жители которых отказались от строительства ЦВ, установки КБМ и ПРВ  (наличие протоколов  отказа)"),
                    NecVodosnabSkvazhKolChelOtkaz = table.Column<int>(type: "integer", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Численность населения, жители которых отказались от строительства ЦВ, установки КБМ и ПРВ  (наличие протоколов  отказа)"),
                    NecVodosnabSkvazhDolyaNaselOtkaz = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Доля населения, жители которых отказались от строительства ЦВ, установки КБМ и ПРВ  (наличие протоколов  отказа), гр.44/гр.9*100"),
                    NecVodosnabSkvazhDolyaSelOtkaz = table.Column<decimal>(type: "numeric", nullable: true, comment: "Нецентрализованное водоснабжение Скважины, колодцы Доля сел, жители которых отказались от  строительства ЦВ, установки КБМ и ПРВ, %, гр.43/гр.8*100"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeloForms_SeloDocuments_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "SeloDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
